...
<html>
  ...
  <body oncontextmenu="return false" class="snippet-body">
        ...
        <div class="col-lg-8 col-md-10">
          <div class="forgot">
            ...
            <ol class="list-unstyled">
              ...
              <li>
                <span class="text-primary text-medium">3. </span>Enter the OTP
                on the next page
              </li>
            </ol>
          </div>
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                /><small class="form-text text-muted"
                  >Enter the registered email address . Then we'll email a OTP
                  to this address.</small
                >
                <%
                ...
                {
                %>
                <p style="color:red">Email not found Please Register</p>
                <% } %>
              </div>
            </div>
   ...
   // var status = document.getElementById("resetFailed");
	//if (status == "resetFailed") {
		//status.innerHtml="wrong email";
